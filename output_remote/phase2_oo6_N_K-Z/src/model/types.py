...
class ActionsData(NamedTuple):
    ...
    Attributes:
        ...
        resource_effects: Shape (num_actions, num_resources) - physical resource delta effects of each action
    """
    ...
    resource_effects: Optional[jnp.ndarray] = None
...
class DecisionVectorD(NamedTuple):
    ...
    token_validity_logits: Optional[jnp.ndarray] = None
